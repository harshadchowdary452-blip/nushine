...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-['Inter',sans-serif] text-[#1E293B]">
      {/* ═══════════════════ HEADER ═══════════════════ */}
      <header className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/95 backdrop-blur-md shadow-sm border-b border-gray-100" : "bg-transparent"}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {platformNav.map((l) => (
                <a key={l.href + l.label} href={l.href} className="px-3 py-1.5 text-[13px] font-medium text-gray-500 hover:text-[#1E3A5F] transition-colors rounded-lg hover:bg-gray-50">{l.label}</a>
              ))}
            </nav>

            <div className="flex items-center gap-2">
              <button onClick={() => navigate("/login")} className="hidden sm:inline-flex text-[13px] font-medium text-[#1E3A5F] hover:bg-blue-50 px-4 py-2 rounded-lg transition-colors">
                Login
              </button>
              ...
              <button onClick={() => setMobileNav(!mobileNav)} className="lg:hidden p-2 text-gray-500 hover:text-[#1E3A5F]" aria-label="Toggle menu">
        ...
        {mobileNav && (
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} className="lg:hidden bg-white border-b border-gray-100 shadow-lg">
            <div className="px-4 py-3 space-y-1">
              {platformNav.map((l) => (
                <a key={l.href + l.label} href={l.href} onClick={() => setMobileNav(false)} className="block px-3 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50 rounded-lg">{l.label}</a>
              ))}
              <hr className="my-2 border-gray-100" />
              <button onClick={() => { navigate("/login"); setMobileNav(false) }} className="w-full text-left px-3 py-2.5 text-sm font-medium text-[#1E3A5F] hover:bg-blue-50 rounded-lg">Login</button>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="text-center max-w-4xl mx-auto mb-12">
            ...
            <motion.div variants={fadeUp} transition={{ duration: 0.5 }} className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <a href="#platform" className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-[#1E3A5F] font-semibold px-8 py-3.5 rounded-xl border border-gray-200 transition-all text-sm">
                Explore Platform
              </a>
            </motion.div>
            <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="mt-4">
              <Link to="/login" className="text-xs text-gray-400 hover:text-[#1E3A5F] transition-colors underline underline-offset-2">
      ...
      <section id="why" className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-5xl mx-auto">
            {whyItems.map((w) => (
              <motion.div key={w.title} variants={fadeUp} transition={{ duration: 0.3 }} className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-lg hover:shadow-gray-100/80 transition-all duration-300">
                <div className="w-10 h-10 rounded-xl bg-[#1E3A5F]/10 flex items-center justify-center mb-4">
                  <w.icon className="h-5 w-5 text-[#1E3A5F]" strokeWidth={1.5} />
                </div>
                <h3 className="text-base font-bold text-[#0F172A] mb-1.5">{w.title}</h3>
      ...
      <section id="platform" className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="text-center mb-16">
            <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#4F46E5] mb-3">Platform</motion.p>
            <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#0F172A]">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {platformModules.map((m) => (
              <motion.div key={m.title} variants={fadeUp} transition={{ duration: 0.3 }} className="group bg-white rounded-2xl border border-gray-100 p-5 hover:border-gray-200 hover:shadow-lg hover:shadow-gray-100/80 transition-all duration-300 cursor-default">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#1E3A5F] mb-3">Patient Management</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
                Every Patient&rsquo;s Journey, Connected.
              </motion.h2>
              <motion.p variants={fadeUp} transition={{ duration: 0.5 }} className="text-gray-500 leading-relaxed mb-6">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5">
              <div className="flex items-center gap-3 mb-4 pb-3 border-b border-gray-100">
                ...
                <div>
                  <p className="text-sm font-bold text-[#0F172A]">Sample Patient</p>
                  <p className="text-[11px] text-gray-400">Patient ID: P-2024-0001</p>
                </div>
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5 order-2 lg:order-1">
              <p className="text-xs font-bold text-gray-700 mb-3">Lead Pipeline Overview</p>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="order-1 lg:order-2">
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#F97316] mb-3">CRM & Lead Management</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
      ...
      <section className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#2563EB] mb-3">Appointments</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5">
              <div className="flex items-center justify-between mb-4">
                <p className="text-xs font-bold text-gray-700">Schedule View</p>
              </div>
              <div className="space-y-2">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 bg-gray-50 rounded-lg border border-gray-100 px-3 py-2">
                    <div className="text-[10px] font-bold text-[#2563EB] w-10">{a.time}</div>
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] font-medium text-gray-700 truncate">{a.label}</p>
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#0F766E] mb-3">Cases</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
                From Case Creation to Treatment Completion
              </motion.h2>
              <motion.p variants={fadeUp} transition={{ duration: 0.5 }} className="text-gray-500 leading-relaxed">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <motion.div key={card.title} variants={fadeUp} transition={{ duration: 0.3 }} className="bg-white rounded-2xl border border-gray-100 p-5">
                <h3 className="text-sm font-bold text-[#0F172A] mb-3">{card.title}</h3>
      ...
      <section className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5 order-2 lg:order-1">
              <p className="text-xs font-bold text-gray-700 mb-3">Treatment Tracking</p>
              <div className="space-y-2">
                {[
                  ...
                  <div key={i} className="bg-gray-50 rounded-lg px-3 py-2">
                    ...
                    <p className="text-[9px] text-gray-400">{t.visits}</p>
                  </div>
                ))}
              </div>
            </motion.div>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="order-1 lg:order-2">
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#059669] mb-3">Treatments</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#4F46E5] mb-3">Billing</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5">
              <div className="flex items-center justify-between mb-4">
                <p className="text-xs font-bold text-gray-700">Sample Invoice</p>
                <span className="text-[10px] font-medium bg-emerald-50 text-emerald-600 px-2 py-0.5 rounded-full">Paid</span>
              </div>
              <div className="bg-gray-50 rounded-lg p-3 mb-3">
                <div className="flex justify-between text-[10px] text-gray-400 mb-1"><span>Patient</span><span>—</span></div>
                <div className="flex justify-between text-[10px] text-gray-400 mb-1"><span>Case</span><span>—</span></div>
                <div className="flex justify-between text-[10px] text-gray-400"><span>Date</span><span>—</span></div>
              </div>
              <div className="space-y-1.5 mb-3">
                {["Line items linked to treatments", "Professional invoice format", "Payment status tracking"].map((item) => (
                  <div key={item} className="flex items-center gap-2 bg-gray-50 rounded px-3 py-1.5">
      ...
      <section className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5 order-2 lg:order-1">
              <p className="text-xs font-bold text-gray-700 mb-3">Performance Visibility</p>
              <div className="grid grid-cols-2 gap-2 mb-4">
                {[
                  ...
                  <div key={m.label} className="bg-gray-50 rounded-lg p-2.5">
                    ...
                    <p className="text-xs font-bold text-gray-600">{m.desc}</p>
                  </div>
                ))}
              </div>
              <div className="bg-gray-50 rounded-lg p-3">
                <p className="text-[9px] font-bold text-gray-600 mb-2">Role-Based Views</p>
                <div className="space-y-1.5">
                  {[
                    ...
                    <div key={r.role} className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-gray-600"><strong>{r.role}</strong> — {r.scope}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="order-1 lg:order-2">
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#7C3AED] mb-3">Doctor Performance</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#D97706] mb-3">Inventory & Indent</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
              ...
              <motion.div variants={fadeUp} transition={{ duration: 0.4 }} className="space-y-3">
                <div className="bg-white rounded-xl border border-gray-100 p-4">
                  <p className="text-xs font-bold text-[#0F172A] mb-2">Hospital Admin</p>
                  <ul className="space-y-1">
                    {["Views default inventory list with remaining stock", "Enters required quantity and estimated cost", "Submits monthly indent"].map((item) => (
                      <li key={item} className="flex items-center gap-2"><Check className="h-3.5 w-3.5 text-[#D97706] shrink-0" /><span className="text-xs text-gray-500">{item}</span></li>
                    ))}
                  </ul>
                </div>
                <div className="bg-white rounded-xl border border-gray-100 p-4">
                  <p className="text-xs font-bold text-[#0F172A] mb-2">Group Admin</p>
                  <ul className="space-y-1">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5">
              <p className="text-xs font-bold text-gray-700 mb-3">Monthly Indent View</p>
              <div className="space-y-1.5">
      ...
      <section className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="bg-white rounded-2xl border border-gray-100 p-5 order-2 lg:order-1">
              <p className="text-xs font-bold text-gray-700 mb-3">Pending Lab Items</p>
              <div className="space-y-2">
                {[
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="order-1 lg:order-2">
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#0F766E] mb-3">Laboratory</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#25D366] mb-3">WhatsApp & Communication</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div key={c.title} variants={fadeUp} transition={{ duration: 0.3 }} className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <h3 className="text-sm font-bold text-[#0F172A] mb-1">{c.title}</h3>
      ...
      <section className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#D946EF] mb-3">Automation</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div key={a.title} variants={fadeUp} transition={{ duration: 0.3 }} className="bg-white rounded-2xl border border-gray-100 p-5">
                <div className="w-9 h-9 rounded-xl bg-[#D946EF]/10 flex items-center justify-center mb-3">
                  <Zap className="h-4 w-4 text-[#D946EF]" strokeWidth={1.5} />
                </div>
                <h3 className="text-sm font-bold text-[#0F172A] mb-1">{a.title}</h3>
      ...
      <section className="py-20 sm:py-28 bg-[#0F172A]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#0EA5E9] mb-3">Analytics & Reports</motion.p>
              ...
              <motion.p variants={fadeUp} transition={{ duration: 0.5 }} className="text-gray-400 leading-relaxed">
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#7C3AED] mb-3">Multi-Hospital</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A] mb-4">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div key={item.title} variants={fadeUp} transition={{ duration: 0.3 }} className="bg-white rounded-2xl border border-gray-100 p-5">
                <div className="w-9 h-9 rounded-xl bg-[#7C3AED]/10 flex items-center justify-center mb-3">
                  <Building2 className="h-4 w-4 text-[#7C3AED]" strokeWidth={1.5} />
                </div>
      ...
      {/* ═══════════════════ STANDALONE + GROUP ═══════════════════ */}
      <section id="organizations" className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#1E3A5F] mb-3">Organization Models</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-2xl sm:text-3xl font-extrabold tracking-tight text-[#0F172A]">
                From Single Clinics to Multi-Hospital Groups
              </motion.h2>
              <motion.p variants={fadeUp} transition={{ duration: 0.5 }} className="mt-5 text-gray-500 leading-relaxed">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={stagger} className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <motion.div variants={fadeUp} transition={{ duration: 0.4 }} className="bg-white rounded-2xl border border-gray-100 p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[#1E3A5F]/10 flex items-center justify-center">
                  <Building className="h-5 w-5 text-[#1E3A5F]" strokeWidth={1.5} />
                </div>
                <div>
                  <h3 className="text-base font-bold text-[#0F172A]">Standalone Clinic / Hospital</h3>
                  <p className="text-xs text-gray-400">Single location</p>
                </div>
              </div>
              <div className="space-y-2">
                <div className="bg-gray-50 rounded-lg px-3 py-2 text-center">
                  <p className="text-xs font-bold text-[#1E3A5F]">Hospital Admin</p>
                </div>
                <div className="flex justify-center"><ChevronDown className="h-4 w-4 text-gray-300" /></div>
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-gray-50 rounded-lg px-3 py-2 text-center">
                    <p className="text-[11px] font-medium text-gray-600">Doctors</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg px-3 py-2 text-center">
                    <p className="text-[11px] font-medium text-gray-600">Staff</p>
                  </div>
                </div>
              </div>
              <p className="text-xs text-gray-400 mt-4 text-center">Manage the complete organization without a separate Group Admin.</p>
            </motion.div>

            <motion.div variants={fadeUp} transition={{ duration: 0.4 }} className="bg-white rounded-2xl border border-gray-100 p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-[#7C3AED]/10 flex items-center justify-center">
                  <Building2 className="h-5 w-5 text-[#7C3AED]" strokeWidth={1.5} />
                </div>
                <div>
                  <h3 className="text-base font-bold text-[#0F172A]">Multi-Hospital Group</h3>
                  <p className="text-xs text-gray-400">Multiple locations</p>
                </div>
              </div>
              <div className="space-y-2">
                <div className="bg-gray-50 rounded-lg px-3 py-2 text-center">
                  <p className="text-xs font-bold text-[#7C3AED]">Group Admin</p>
                </div>
                <div className="flex justify-center"><ChevronDown className="h-4 w-4 text-gray-300" /></div>
                <div className="grid grid-cols-3 gap-1.5">
                  {["Hospital A", "Hospital B", "Hospital C"].map((h) => (
                    <div key={h} className="bg-gray-50 rounded-lg px-2 py-2 text-center">
                      <p className="text-[10px] font-medium text-gray-600">{h}</p>
                    </div>
                  ))}
                </div>
                <div className="flex justify-center"><ChevronDown className="h-4 w-4 text-gray-300" /></div>
                <div className="grid grid-cols-3 gap-1.5">
                  {["Admins", "Doctors", "Staff"].map((r) => (
                    <div key={r} className="bg-gray-50 rounded-lg px-2 py-1.5 text-center">
                      <p className="text-[10px] text-gray-500">{r}</p>
                    </div>
                  ))}
                </div>
              </div>
              <p className="text-xs text-gray-400 mt-4 text-center">Centralized visibility across all locations from one dashboard.</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#0F766E] mb-3">How It Works</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#0F172A]">
      ...
      {/* ═══════════════════ BOOK A DEMO ═══════════════════ */}
      <section id="demo" className="py-20 sm:py-28 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={stagger}>
              <motion.p variants={fadeUp} transition={{ duration: 0.4 }} className="text-xs font-bold tracking-[0.2em] uppercase text-[#1E3A5F] mb-3">Get Started</motion.p>
              <motion.h2 variants={fadeUp} transition={{ duration: 0.5 }} className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#0F172A] mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#1E3A5F] via-[#163050] to-[#0F172A] p-10 sm:p-16 text-center">
            ...
            <div className="relative z-10">
              ...
              <motion.div variants={fadeUp} transition={{ duration: 0.5 }} className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="#demo" className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-[#1E3A5F] font-semibold px-8 py-3.5 rounded-xl transition-all shadow-lg text-sm">
                  Book a Demo <ArrowRight className="h-4 w-4" />
                </a>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {["Features", "Pricing", "Demo", "Login"].map((l) => (
                  <li key={l}><a href={l === "Demo" ? "#demo" : l === "Login" ? "/login" : `#${l.toLowerCase()}`} className="text-xs text-gray-400 hover:text-[#1E3A5F] transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="text-xs font-bold text-[#0F172A] uppercase tracking-wider mb-3">Company</h4>
              <ul className="space-y-2">
                {["About", "Contact", "Careers", "Blog"].map((l) => (
                  <li key={l}><a href="#" className="text-xs text-gray-400 hover:text-[#1E3A5F] transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="text-xs font-bold text-[#0F172A] uppercase tracking-wider mb-3">Legal</h4>
              <ul className="space-y-2">
