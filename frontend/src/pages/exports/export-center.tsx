...
export default function ExportCenter() {
  ...
  const filteredModules = searchQuery
    ? visibleModules.filter((m: { id: string; label: string }) =>
  ...
  const exportMutation = useMutation({
    mutationFn: async () => {
      ...
      return {
        blob,
        label:
          modules.find((m: { id: string; label: string }) => m.id === selectedModule)?.label ||
          selectedModule,
      }
    },
    onSuccess: ({ blob, label }) => {
      ...
      addToast({
        ...
        description: `${label} exported as ${selectedFormat.toUpperCase()}`,
        variant: "success",
      })
    },
    onError: () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <Card className="lg:col-span-1">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-2">
                  <Button className="w-full" onClick={handleExport} disabled={disabled}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>
                    Revenue, collections, outstanding, expenses, net profit, and doctor revenue
                    breakdown
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>
                    Executive summary, revenue, patients, appointments, treatments, CRM and recall
                    summary
                  </CardDescription>
                </CardHeader>
                <CardContent>
