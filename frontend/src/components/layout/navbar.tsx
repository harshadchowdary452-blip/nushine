...
import { PanelLeftOpen, Bell, ChevronDown, LogOut, User, Calendar, AlertCircle, MessageSquare, Clock, Sparkles } from "lucide-react"
...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center border-b border-gray-100 bg-white/80 glass px-4 transition-all duration-300">
      <div className="flex w-full items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          {/* Brand caption - visible on tablet and up */}
          <div className="hidden sm:flex items-center gap-3">
            <div className="h-5 w-px bg-gray-200" />
            <div className="flex flex-col">
              <span className="text-xs font-semibold bg-gradient-to-r from-[#0EA5E9] to-[#14B8A6] bg-clip-text text-transparent">
                NUSHINE Dental
              </span>
