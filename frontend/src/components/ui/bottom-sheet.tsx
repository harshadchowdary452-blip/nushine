      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-50 rounded-t-2xl bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.1)] md:hidden safe-area-bottom max-h-[85vh] overflow-y-auto"
          >
