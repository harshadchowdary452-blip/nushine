...
class TreatmentFollowUpRule(Base):
    ...
    recall_6_month: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    recall_12_month: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
