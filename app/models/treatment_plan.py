...
class TreatmentPlan(Base):
    ...
    discount_type: Mapped[str] = mapped_column(String(20), default="PERCENTAGE", server_default="PERCENTAGE", nullable=False)
    discount_percent: Mapped[float] = mapped_column(Float, default=0.0, server_default="0", nullable=False)
