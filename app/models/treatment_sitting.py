...
class TreatmentSitting(Base):
    ...
    # Billing sync (invoice is the source of truth; kept in sync by BillingSyncService)
    ...
    invoice_status: Mapped[str] = mapped_column(String(20), default="NOT_INVOICED", nullable=False)
