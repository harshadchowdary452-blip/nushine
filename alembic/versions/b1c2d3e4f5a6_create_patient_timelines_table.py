...
def upgrade() -> None:
    if not table_exists("patient_timelines"):
        op.create_table(
            "patient_timelines",
    ...
    if not index_exists("patient_timelines", "ix_patient_timelines_patient_id"):
        op.create_index("ix_patient_timelines_patient_id", "patient_timelines", ["patient_id"])
    if not index_exists("patient_timelines", "ix_patient_timelines_module"):
        op.create_index("ix_patient_timelines_module", "patient_timelines", ["module"])
    if not index_exists("patient_timelines", "ix_patient_timelines_created_at"):
        op.create_index("ix_patient_timelines_created_at", "patient_timelines", ["created_at"])


def downgrade() -> None:
    for index in ("ix_patient_timelines_created_at", "ix_patient_timelines_module", "ix_patient_timelines_patient_id"):
        if index_exists("patient_timelines", index):
            op.drop_index(index, table_name="patient_timelines")
    if table_exists("patient_timelines"):
